...
class NetworkSafeVideo extends StatefulWidget {
  final String videoUrl;
  final VoidCallback? onTap;

  const NetworkSafeVideo({super.key, required this.videoUrl, this.onTap});

  @override
  State<NetworkSafeVideo> createState() => _NetworkSafeVideoState();
}

class _NetworkSafeVideoState extends State<NetworkSafeVideo> {
